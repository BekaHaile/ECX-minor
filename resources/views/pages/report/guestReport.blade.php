        ...
        @if($count == 0)
            @if(count($coffees) > 0)
                <div class="row" id="print-content">
                    <div class="col-md-6 mb-3" style="margin-left: 10px;">
                    ...
                    <div class="col-md-5 mb-3" style="margin-left: 10px;">
        ...
        @elseif($count == 1)
            @if(count($coffees2) > 0)
                <div class="row" id="print-content2">
                    <div class="col-md-6 mb-3" style="margin-left: 160px;">
                        <div class="table-wrapper-scroll-y my-custom-scrollbar" style="margin-top: 20px;">
                            <table class="table table-hover table-bordered table-striped mb-0">
                                <thead>
                                <tr>
    ...
    <script type="text/javascript">
        ...
        var myBarChart = new Chart(ctxB, {
                ...
                data: {
                    labels: regions,
                    datasets: [{
                        label: 'Price of 100KG Coffee in birr',
                        data: price,
                        backgroundColor: [
                            'rgba(255, 99, 132, 0.2)',
                            'rgba(54, 162, 235, 0.2)',
