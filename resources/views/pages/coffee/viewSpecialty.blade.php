        ...
        <div class="col-md-10 mb-3">
            <div class="jumbotron bg-light" style="margin: 20px;">
                ...
                <div class="col-md-4" style="margin-left: 780px; margin-bottom: 10px;">
                    <form action="/searchSpecialty" method="get">
                        <div class="input-group">
                            ...
                            <input type="number" name="view" @foreach($coffees as $coffee) @if($coffee->specialtyFill == 1) value="1" @else value="0" @break @endIf @endforeach hidden>
