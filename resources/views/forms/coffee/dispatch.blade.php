                        ...
                        <form class="needs-validation" method="POST" action="/coffee">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="tel" class="form-control"   name="driverPhone" id="driverPhone" placeholder="" value="" required>
                                    <div class="invalid-feedback">
                                        Valid phone number is required.
                                    </div>
                                </div>
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLongTitle">Dispatch Data</h5>
