                        ...
                        <form class="needs-validation" method="POST" action="/coffees/{{ $coffee->id }}/updateSpecialty">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="range" name="wetnessPercent" id="wetnessPercent" value={{ $coffee -> wetnessPercent }} min="1" max="100" oninput="range_weight_disp1.value = wetnessPercent.value">
                                        <div class="input-group-append">
                                            <span class="input-group-text" style="margin-left: 10px;"><output  id="range_weight_disp1">{{ $coffee -> wetnessPercent }}</output><strong>%</strong></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="range" name="specialty" id="specialty" value={{ $coffee -> specialty }} min="1" max="100" oninput="range_weight_disp.value = specialty.value">
                                        <div class="input-group-append">
                                            <span class="input-group-text" style="margin-left: 10px;"><output  id="range_weight_disp">{{ $coffee -> specialty }}</output><strong>%</strong></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
